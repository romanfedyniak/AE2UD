...
public final class CardTrait {
    ...
    /**
     * A trait that says nothing of itself in a card's tooltip. Right for anything a card either has or has
     * not, where the list of hosts underneath already tells the whole story.
     */
