 ...
 * itself ({@link #createFilter()}) - ACCESS, STORAGE_FILTER, the inverter trait (whitelist/blacklist), the
 * sticky trait and priority are all inherited, unchanged, from {@link PartStorageBus#getInternalHandler()}.
 */
