...
/**
 * Generic key-interest bookkeeping shared by every watcher-based grid cache (storage, crafting).
 * Replaces the {@code IAEStack}-keyed {@code GenericInterestManager}.
 */
