...
public class WrappedGenericStackModel implements IModel {
    ...
    private static final ResourceLocation MODEL_BASE = new ResourceLocation(AppEng.MOD_ID, "item/wrapped_generic_stack_base");
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new WrappedGenericStackDispatcherBakedModel(bakedBaseModel, format, bakedTextureGetter);
    }
