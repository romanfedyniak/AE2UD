...
public class GuiImgButton extends GuiButton implements ITooltip {
    ...
    public GuiImgButton(final int x, final int y, final Enum idx, final Enum val) {
        ...
        if (appearances == null) {
            ...
            // A search box with a padlock on it: shut and still written in, or open and emptied.
            this.registerApp(16 * 2 + 7, Settings.SEARCH_KEEP, YesNo.NO, ButtonToolTips.SearchKeep, ButtonToolTips.SearchKeepNo);
            this.registerApp(16 * 2 + 8, Settings.SEARCH_KEEP, YesNo.YES, ButtonToolTips.SearchKeep, ButtonToolTips.SearchKeepYes);

            this.registerApp(16 * 2 + 9, Settings.PICK_BLOCK, YesNo.NO, ButtonToolTips.PickBlock, ButtonToolTips.PickBlockNo);
            this.registerApp(16 * 2 + 10, Settings.PICK_BLOCK, YesNo.YES, ButtonToolTips.PickBlock, ButtonToolTips.PickBlockYes);
            ...
            this.registerApp(16 * 13 + 6, Settings.HIDE_STORED, YesNo.NO, ButtonToolTips.HideStored, ButtonToolTips.Disabled);
            this.registerApp(16 * 13 + 7, Settings.HIDE_STORED, YesNo.YES, ButtonToolTips.HideStored, ButtonToolTips.Enable);
        ...
        this.registerApp(16 * 3 + 13, Settings.ACTIONS, ActionItems.UPLOAD_UNDO, ButtonToolTips.PatternUploadUndo, ButtonToolTips.PatternUploadUndoHint);
            ...
            this.registerApp(3 + 8 * 16, Settings.ACTIONS, ActionItems.CONFIGURE_PICKED_UP_TYPES,
                    ButtonToolTips.ConfigurePickedUpTypes, ButtonToolTips.ConfigurePickedUpTypesHint);

            this.registerApp(11 + 2 * 16, Settings.PLANE_MODE, PlaneMode.PASSIVE,
                    ButtonToolTips.PlaneMode, ButtonToolTips.PlaneModePassive);
            this.registerApp(12 + 2 * 16, Settings.PLANE_MODE, PlaneMode.ACTIVE,
                    ButtonToolTips.PlaneMode, ButtonToolTips.PlaneModeActive);
            this.registerApp(6, Settings.ACTIONS, ActionItems.CLOSE, ButtonToolTips.Clear, ButtonToolTips.ClearSettings);
            this.registerApp(6, Settings.ACTIONS, ActionItems.RESET_IDENTITY, ButtonToolTips.ResetIdentity, ButtonToolTips.ResetIdentityDesc);
            this.registerApp(11 + 3 * 16, Settings.ACTIONS, ActionItems.STASH, ButtonToolTips.Stash, ButtonToolTips.StashDesc);
            this.registerApp(12 + 3 * 16, Settings.ACTIONS, ActionItems.STASH_TO_PLAYER_INV, ButtonToolTips.StashToPlayer, ButtonToolTips.StashToPlayerDesc);
            ...
            this.registerApp(16 + 5, Settings.BLOCK, BlockingMode.YES, ButtonToolTips.InterfaceBlockingMode, ButtonToolTips.Blocking);
            this.registerApp(16 + 4, Settings.BLOCK, BlockingMode.NO, ButtonToolTips.InterfaceBlockingMode, ButtonToolTips.NonBlocking);
            this.registerApp(16 * 3 + 10, Settings.BLOCK, BlockingMode.SMART, ButtonToolTips.InterfaceBlockingMode, ButtonToolTips.SmartBlocking);
