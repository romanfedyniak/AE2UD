...
public class PacketValueConfig extends AppEngPacket {
    ...
    public void serverPacketData(final INetworkInfo manager, final AppEngPacket packet, final EntityPlayer player) {
        ...
        if (this.Name.equals("Item") && ((!player.getHeldItem(EnumHand.MAIN_HAND).isEmpty() && player.getHeldItem(EnumHand.MAIN_HAND)
            ...
            qk.cancelCrafting();
        } else if (this.Name.equals("TileCrafting.Suspend") && c instanceof ContainerCraftingCPU) {
            final ContainerCraftingCPU qk = (ContainerCraftingCPU) c;
            qk.suspendCrafting();
        } else if (this.Name.equals("TileCrafting.SelectionMode") && c instanceof ContainerCraftingCPU) {
            final ContainerCraftingCPU qk = (ContainerCraftingCPU) c;
            qk.cycleSelectionMode(this.Value.equals("Backwards"));
            ...
            if (c instanceof ContainerPatternEncoder) {
                ...
                if (this.Name.equals("PatternTerminal.CraftMode")) {
                    ...
                    cpt.setInverted(this.Value.equals("1"));
                }
            }
